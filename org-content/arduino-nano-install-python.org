...
running [[https://micropython.org][MicroPython]] (one of the useful side effect of kids is an
excuse to buy stuff for projects). It's worth noting a couple of the
issues that came up.
